...
class CustomerlistActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        while(cursor.moveToNext()) {
            custList.add(CustomerC(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6)))
        }
        cursor.close()
        sqlDB.close()
        ...
        listView.setOnItemClickListener { adapterView, view, i, l ->
            ...
            var intent1 = Intent(application, DetailActivity::class.java)
